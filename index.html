...
<!-- =============== NAVBAR ============ -->
    ...
    <nav id="top" class="navbar navbar-inverse">
      <div class="container">
        <a class="navbar-brand" href="index.html"><i class="icon-objc" style="font-size:2em"></i> CodeLab</a>
    ...
    <div class="container">
      ...
      <div class="container marketing">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <i class="fa fa-wrench" style="font-size:10em"></i>
            <h2>Herramientas</h2>
          ...
          <div class="col-lg-4">
            <i class="fa fa-mobile" style="font-size:10em"></i>
            <h2>Móviles</h2>
            <p>Seguro que desde hace tiempo, tienes pensada una app en a cebeza? Aqui tienes ayuda para empezar a desarrollar para iPhone, Android o Firefox.</p>
...
<!-- ================= FOOTER =========== -->
        ...
        <div class="footer">
          <div class="container">
             <p class="pull-left"><a rel="license" href="http://creativecommons.org/licenses/by/4.0/"><img alt="Licencia de Creative Commons" style="border-width:0" src="http://i.creativecommons.org/l/by/4.0/88x31.png" /></a>. &middot; <a href="#">Contacto</a></p>
